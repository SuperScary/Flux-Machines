package net.superscary.fluxmachines.attributes;
...
/**
 * Defines modifiable attributes in a machine. {@link net.superscary.fluxmachines.core.upgrades.UpgradeFunction} modifies
 * these values.
 * <p>
 * Each value has an identifier that is linked to a value which allows Upgrades to be modified.
 *
 * @since 1.0.0
 * @author SuperScary
 */
