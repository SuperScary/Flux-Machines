...
public class FMConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_URANIUM_ORE_KEY_LARGE = registerKey("uranium_ore_large");
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_URANIUM_ORE_KEY_SMALL = registerKey("uranium_ore_small");
    ...
    public static void bootstrap (BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldUraniumOres = List.of(OreConfiguration.target(stoneReplaceables, FMBlocks.URANIUM_ORE.block().defaultBlockState())/*, OreConfiguration.target(deepslateReplaceables, FMBlocks.URANIUM_ORE.block().defaultBlockState())*/);
        ...
        register(context, OVERWORLD_URANIUM_ORE_KEY_LARGE, Feature.ORE, new OreConfiguration(overworldUraniumOres, 4));
        register(context, OVERWORLD_URANIUM_ORE_KEY_SMALL, Feature.ORE, new OreConfiguration(overworldUraniumOres, 2));
