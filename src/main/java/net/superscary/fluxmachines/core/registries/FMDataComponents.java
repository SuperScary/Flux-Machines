...
public class FMDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<MimickingRecord>> MIMICKING = register("mimicking", builder -> builder.persistent(Codecs.MIMICKING_CODEC));
