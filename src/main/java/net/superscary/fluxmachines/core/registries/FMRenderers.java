...
import net.superscary.fluxmachines.model.renderer.CrucibleBlockEntityRenderer;
...
public class FMRenderers {
	...
	public static void registerBER (EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(FMBlockEntities.CRUCIBLE.get(), CrucibleBlockEntityRenderer::new);
	}
