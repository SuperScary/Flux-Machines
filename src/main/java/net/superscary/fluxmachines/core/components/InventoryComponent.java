package net.superscary.fluxmachines.core.components;
...
public record InventoryComponent (List<ItemStack> inventory) {
    ...
    public static final Codec<InventoryComponent> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(Codec.list(STACK_CODEC).fieldOf("inventory").forGetter(InventoryComponent::inventory)).apply(instance, InventoryComponent::new));
    ...
    public boolean equals (Object obj) {
        if (obj == this) {
            ...
            return obj instanceof InventoryComponent ff
                    && this.inventory == ff.inventory;
        }
    }
}
